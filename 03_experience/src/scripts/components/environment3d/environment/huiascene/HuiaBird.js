    ...
    for (var i = 0; i < this.data.geometries.length; i++)
    {
      ...
      this.fireBallShader = new THREE.ShaderMaterial(

        {
          ...
          vec4 Fireball1545337426287_23_main() 
              {
                    vec4 Fireball1545337426287_23_gl_FragColor = vec4(0.0);
                    ...
                    Fireball1545337426287_23_gl_FragColor = vec4(color.rgb, 1.0);
                    return Fireball1545337426287_23_gl_FragColor *= 1.0;
                }
          void main() 
              {
                    gl_FragColor = Fireball1545337426287_23_main();    }
          `,
          ...
          vec4 Fireball1545337426287_23_main() 
              {
                    vec4 Fireball1545337426287_23_gl_Position = vec4(0.0);
                    ...
                    Fireball1545337426287_23_gl_Position = projectionMatrix * modelViewMatrix * vec4(newPosition, 1.0);
                    return Fireball1545337426287_23_gl_Position *= 1.0;
                }
          void main() 
              {
                    gl_Position = Fireball1545337426287_23_main();    }
          `,
          "uniforms": {
            "tExplosion": {
              "value":  new THREE.TextureLoader().load( "/static/images/background2.png" ),
              "type": "t",
              "glslType": "sampler2D"
            },
            "brightness": {
      ...
      if(mesh.geometry.name.indexOf("Sphere001") > -1) {
        ...
        this.sphere = mesh;
        this.sphere.material =  this.basicShader; // this.fireBallShader; // 
